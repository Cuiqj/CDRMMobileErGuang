...
- (void)viewDidLoad
{
    ...
    [self.uibuttonResetForm setTitle:@"更新文书格式" forState:UIControlStateNormal];
    [self.uibuttonResetForm setTitleColor:[UIColor redColor] forState:UIControlStateNormal];
