                        ...
                        if ([[TBXML elementName:uitextfield] isEqualToString:@"UITextField"]) {
                            ...
                            if (originInXML) {
                                ...
                                /* modify by lxm 2013.05.08
                                 ...
                                 CGFloat y=[[TBXML valueOfAttributeNamed:@"y" forElement:originInXML] floatValue]+prTopMargin;
                                 */
                                CGFloat x=([[TBXML valueOfAttributeNamed:@"x" forElement:originInXML] floatValue]+prLeftMargin)*MMTOPIX * SCALEFACTOR;
                                CGFloat y=([[TBXML valueOfAttributeNamed:@"y" forElement:originInXML] floatValue]+prTopMargin)*MMTOPIX * SCALEFACTOR;
                                ...
                                if (sizeInXML) {
                                    ...
                                    if ([contentString sizeWithFont:font].width > width) {
                                        font = [UIFont fontWithName:SongTi size:9];
                                    }
