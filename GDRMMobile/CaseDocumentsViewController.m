...
- (void)viewDidLoad
{
    ...
    if (self.docPrinterState==kPDFView) {
        ...
        CGRect docPrinterFrame = self.docPrinter.view.frame;
        if([[self.docPrinter class] isSubclassOfClass: NSClassFromString(@"AtonementNoticePrintViewController") ]){
            self.docPrinter.view.frame=CGRectMake(0, 0, 963, 1357);
        }
        ...
        CGRect frame = self.docPrinter.view.bounds;
