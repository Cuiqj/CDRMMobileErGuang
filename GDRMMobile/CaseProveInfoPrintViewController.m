...
- (void)pageLoadInfo
{
    ...
    //案由
    self.textcase_short_desc.text = [NSString stringWithFormat:@"%@%@因%@%@", citizen.automobile_number, citizen.automobile_pattern, caseInfo.case_reason,self.caseProveInfo.case_short_desc];
    ...
    //修改“左，右”为“左侧，右侧”
    if(([self.caseProveInfo.remark rangeOfString:@"右"].location !=NSNotFound)&&([self.caseProveInfo.remark rangeOfString:@"侧"].location ==NSNotFound))//_roaldSearchText
    {
        self.caseProveInfo.remark = [NSString stringWithFormat:@"%@%@",self.caseProveInfo.remark,@"侧"];
    }else if (([self.caseProveInfo.remark rangeOfString:@"左"].location !=NSNotFound)&&([self.caseProveInfo.remark rangeOfString:@"侧"].location ==NSNotFound)){
        self.caseProveInfo.remark = [NSString stringWithFormat:@"%@%@",self.caseProveInfo.remark,@"侧"];
    }
...
- (void)pageSaveInfo
{
    ...
    //修改“左，右”为“左侧，右侧”
    if(([self.textprover_place.text rangeOfString:@"右"].location !=NSNotFound)&&([self.textprover_place.text rangeOfString:@"侧"].location ==NSNotFound))//_roaldSearchText
    {
        self.textprover_place.text = [NSString stringWithFormat:@"%@%@",self.textprover_place.text,@"侧"];
    }else if (([self.textprover_place.text rangeOfString:@"左"].location !=NSNotFound)&&([self.textprover_place.text rangeOfString:@"侧"].location ==NSNotFound)){
        self.textprover_place.text = [NSString stringWithFormat:@"%@%@",self.textprover_place.text,@"侧"];
    }
