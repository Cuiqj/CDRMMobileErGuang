...
- (void)hasUpdateVersion{
    ...
    //蒲公英的apikey，appkey
    NSDictionary *paramDic = @{@"_api_key":@"d98734ffcbcb99a86ff217e63c46ecfe",@"appKey":@"295f3a39713220e256c9464cec730fca"};
...
-(void)initServer{
    ...
    NSString *libraryDirectory = [paths objectAtIndex:0];    //沙盒路径
    ...
    self.projectDictionary = [settings objectForKey:@"Projectname"];  //读取信息
